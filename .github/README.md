...
[`@aws-sdk/client-backup-gateway`](https://www.npmjs.com/package/@aws-sdk/client-backup-gateway/v/3.1127.0).
...
- @aws-sdk/client-backup-gateway v3.1127.0 - [https://cloud-sdk-builds.github.io/?sdk=client-backup-gateway&version=3.1127.0](https://cloud-sdk-builds.github.io/?sdk=client-backup-gateway&version=3.1127.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-backup-gateway@3.1127.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NicsZBWacpn7dQHLVsE5XehvV92sehlne/PIC+0mnv/+crizhWveSKniaHyharn+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-backup-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-backup-gateway@3.1127.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-backup-gateway@3.1127.0/index.min.mjs": "sha384-NicsZBWacpn7dQHLVsE5XehvV92sehlne/PIC+0mnv/+crizhWveSKniaHyharn+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-backup-gateway/blob/refs/tags/3.1127.0/LICENSE
```
