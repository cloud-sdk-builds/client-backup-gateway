...
[`@aws-sdk/client-backup-gateway`](https://www.npmjs.com/package/@aws-sdk/client-backup-gateway/v/3.1115.0).
...
- @aws-sdk/client-backup-gateway v3.1115.0 - [https://cloud-sdk-builds.github.io/?sdk=client-backup-gateway&version=3.1115.0](https://cloud-sdk-builds.github.io/?sdk=client-backup-gateway&version=3.1115.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-backup-gateway@3.1115.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8B+UWbGbjnXurm5DtKMHJue4isXSuSApr5RT6V1CGkbohZrsdUipaCWsashCpAC1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-backup-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-backup-gateway@3.1115.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-backup-gateway@3.1115.0/index.min.mjs": "sha384-8B+UWbGbjnXurm5DtKMHJue4isXSuSApr5RT6V1CGkbohZrsdUipaCWsashCpAC1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-backup-gateway/blob/refs/tags/3.1115.0/LICENSE
```
