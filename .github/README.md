...
[`@aws-sdk/client-backup-gateway`](https://www.npmjs.com/package/@aws-sdk/client-backup-gateway/v/3.1049.0).
...
- @aws-sdk/client-backup-gateway v3.1049.0 - [https://cloud-sdk-builds.github.io/?sdk=client-backup-gateway&version=3.1049.0](https://cloud-sdk-builds.github.io/?sdk=client-backup-gateway&version=3.1049.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-backup-gateway@3.1049.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1NpsvqFqrFBcz2hG7Zl4GolLgUu0Gbe8a9pwy7OqJrWiIKDNGb0LA4p3+DCdWEtW
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-backup-gateway/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-backup-gateway": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-backup-gateway@3.1049.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-backup-gateway@3.1049.0/index.min.mjs": "sha384-1NpsvqFqrFBcz2hG7Zl4GolLgUu0Gbe8a9pwy7OqJrWiIKDNGb0LA4p3+DCdWEtW"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-backup-gateway";
...
```
https://github.com/cloud-sdk-builds/client-backup-gateway/blob/refs/tags/3.1049.0/LICENSE
```
